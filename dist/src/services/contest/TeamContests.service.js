...
let TeamContestService = class TeamContestService extends Contests_service_1.ContestsService {
    constructor(contests, submissions, standings, users, teams, trackers, groups, plateformBuilder) {
    ...
    create(contest, userID) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            let new_contest = {
                ...
                type: InterfaceFacade_1.ContestType.TEAM,
                problems: [],
                users: [],
                teams: [],
                submissions: [],
    ...
    register(contestID, teamID) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (contest.type != InterfaceFacade_1.ContestType.TEAM) {
                    return reject({
                        code: 406 /* NOT_ACCEPTABLE */,
                        body: {
                ...
                team = yield this.teamExists(teamID);
                if (!team) {
                    return reject({
                        code: 404 /* NOT_FOUND */,
                        body: {
                ...
                let isRegistered = yield this.isTeamAlreadyRegistered(team, contestID);
                if (isRegistered) {
                    return reject({
                        code: 409 /* CONFLICT */,
                        body: {
    ...
    teamExists(teamID) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let team;
            try {
                team = yield this.teams.findById(teamID).exec();
                return resolve(team);
            }
            catch (err) {
                return reject(err);
     ...
     * @param contestID
     */
    isTeamAlreadyRegistered(team, contestID) {
        return new Promise((resolve) => {
            let contests = team.contests;
    ...
    unregister(contestID, teamID) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                tracker = yield this.trackers.findOneAndRemove({ contestID: contestID, contestants: team._id }).exec();
                standing = yield this.standings.findOne({ contestID: contest._id }).exec();
                let saveStanding = new this.standings(standing);
                let saveTeam = new this.teams(team);
                let saveContest = new this.contests(contest);
                ...
                yield saveStanding.save();
                saveTeam.contests = saveTeam.contests.filter((cont) => cont != contestID);
                yield saveTeam.save();
                saveContest.teams = saveContest.teams.filter((us) => us != teamID);
                yield saveContest.save();
                return resolve({
                    code: 200 /* OK */,
                    body: {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                for (let i = 0; i < contest.problems.length; i++) {
                    ...
                    yield this.queryTeams(contest, contest.problems[i], i);
                }
                return resolve();
            }
            catch (err) {
     ...
     * @param problem
     */
    queryTeams(contest, problem, problemIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let team;
            try {
                for (let i = 0; i < contest.teams.length; i++) {
                    yield this.queryUsers(contest, problem, contest.teams[i], problemIndex);
                }
                return resolve();
            }
            catch (err) {
     ...
     * @param contest
     */
    queryUsers(contest, problem, team, problemIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let plateform;
            ...
            try {
                for (let i = 0; i < team.members.length; i++) {
                    let user = team.members[i];
                    result = yield plateform.updateContest(contest, user, problem);
                    statusFiltered = result.body.result;
                    yield this.querySubmissions(contest, problem, statusFiltered, plateform, team, problemIndex);
                }
                return resolve();
            }
            catch (err) {
     ...
     * @param team
     */
    querySubmissions(contest, problem, status, plateform, team, problemIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                console.log('INSIDE QUERY SUBMISSIONS');
                for (let i = 0; i < status.length; i++) {
                    yield this.getSubmission(contest, problem, status[i], plateform, team, problemIndex);
                }
                return resolve();
            }
            catch (err) {
     ...
     * @param sub
     */
    getSubmission(contest, problem, sub, platform, team, problemIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let tracker;
            try {
...
TeamContestService = __decorate([
    ...
    __param(4, common_1.Inject(Teams_1.Teams)),
    __param(5, common_1.Inject(Trackers_1.Trackers)),
    __param(6, common_1.Inject(Groups_1.Groups)),
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object, Object, Object, PlateformBuilding_service_1.default])
], TeamContestService);
exports.TeamContestService = TeamContestService;
//# sourceMappingURL=TeamContests.service.js.map